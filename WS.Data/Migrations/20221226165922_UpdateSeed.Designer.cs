...
namespace WS.Data.Migrations
{
    ...
    [Migration("20221226165922_UpdateSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WS.Data.Entities.Topic", b =>
                {
                    ...
                    b.Property<string>("StoryIdStory")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("IdTopic");

                    b.HasIndex("StoryIdStory");
                    ...
                    b.HasData(
                        new
                        {
                            IdTopic = "badc99e6-2314-4480-a3f4-34bb06260b6f",
                            NameTopic = "Tiên hiệp"
                        },
                        new
                        {
                            IdTopic = "e0ea92e0-f1ab-4b7c-a8c3-9d8bfb919cbb",
                            NameTopic = "Kiếm hiệp"
                        },
                        new
                        {
                            IdTopic = "4f1c3f45-eb91-41e3-9622-1057272aa338",
                            NameTopic = "Ngôn tình"
                        });
                });
            ...
            modelBuilder.Entity("WS.Data.Entities.Topic", b =>
                {
                    b.HasOne("WS.Data.Entities.Story", null)
                        .WithMany("ListTopic")
                        .HasForeignKey("StoryIdStory");
                });
